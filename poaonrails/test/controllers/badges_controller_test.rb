...
class BadgesControllerTest < ActionController::TestCase
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post :create, badge: { category: @badge.category, description: @badge.description, icon: @badge.icon, name: @badge.name, school_id: @badge.school_id }
    end
  ...
  test "should update badge" do
    patch :update, id: @badge, badge: { category: @badge.category, description: @badge.description, icon: @badge.icon, name: @badge.name, school_id: @badge.school_id }
    assert_redirected_to badge_path(assigns(:badge))
  end
